...
def create_item(x, y):
	...
	if choice == 'wooden sword':
		...
		item = Object(x, y, '/', 'Brass sword', libtcod.orange, equipment=equipment_component, item=None, always_visible=True)
		...
		item = Object(x, y, '/', 'Golden sword', libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'demon sword':
		equipment_component = Equipment(slot='left hand', power_bonus=18)
		item = Object(x, y, '/', 'Demon sword', libtcod.dark_purple, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'ares sword':
		equipment_component = Equipment(slot='left hand', power_bonus=25)
		item = Object(x, y, '/', 'Ares sword', libtcod.yellow, equipment=equipment_component, item=None, always_visible=True)
		...
		equipment_component = Equipment(slot='left hand', power_bonus=25)
		item = Object(x, y, '/', 'Brass sword', libtcod.white, equipment=equipment_component, item=None, always_visible=True)

	##AXES##

	elif choice == 'wooden axe':
		equipment_component = Equipment(slot='left hand', power_bonus=2)
		item = Object(x, y, chr(245), 'Wooden axe', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'bronze axe':
		equipment_component = Equipment(slot='left hand', power_bonus=4)
		item = Object(x, y, chr(245), 'Bronze axe', libtcod.orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'rusty steel axe':
		equipment_component = Equipment(slot='left hand', power_bonus=5)
		item = Object(x, y, chr(245), 'Rusty steel axe', libtcod.darkest_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel axe':
		equipment_component = Equipment(slot='left hand', power_bonus=6)
		item = Object(x, y, chr(245), 'Steel axe', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'diamond axe':
		equipment_component = Equipment(slot='left hand', power_bonus=10)
		item = Object(x, y, chr(245), 'Diamond axe', libtcod.light_blue, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'ares axe':
		equipment_component = Equipment(slot='left hand', power_bonus=25)
		item = Object(x, y, chr(245), 'Ares axe', libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'godsbane axe':
		equipment_component = Equipment(slot='left hand', power_bonus=35)
		item = Object(x, y, chr(245), 'Godsbaneaxe', libtcod.light_blue, equipment=equipment_component, item=None, always_visible=True)

    ##WAR HAMMERS##

	elif choice == 'stone war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=5)
		item = Object(x, y, chr(25), 'Stone war hammer', libtcod.grey, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'bronze war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=8)
		item = Object(x, y, chr(25), 'Bronze war hammer', libtcod.orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'pig iron war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=12)
		item = Object(x, y, chr(25), 'Pig iron war hammer', libtcod.light_grey, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=15)
		item = Object(x, y, chr(25), 'Steel war hammer', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'obsidian war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=20)
		item = Object(x, y, chr(25), 'Obsidian war hammer', libtcod.darkest_grey, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'unobtanium war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=30)
		item = Object(x, y, chr(25), 'Unobtanium war hammer', libtcod.desaturated_green, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'godsbane war hammer':
		equipment_component = Equipment(slot='left hand', power_bonus=45)
		item = Object(x, y, chr(25), 'godsbane war hammer', libtcod.light_grey, equipment=equipment_component, item=None, always_visible=True)
	...
	##GAUNTLETS##
		...
		item = Object(x, y, chr(7), 'Silk gauntlets', libtcod.light_purple, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'wooden gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=2)
		item = Object(x, y, chr(170), 'Wooden gauntlets', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'bronze gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=4)
		item = Object(x, y, chr(170), 'Bronze gauntlets', libtcod.orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'iron gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=5)
		item = Object(x, y, chr(170), 'Iron gauntlets', libtcod.lighter_grey, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=7)
		item = Object(x, y, chr(170), 'Steel gauntlets', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'obsidian gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=9)
		item = Object(x, y, chr(170), 'Wooden gauntlets', libtcod.black, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'divine gauntlets':
		equipment_component = Equipment(slot='hands', defense_bonus=12)
		item = Object(x, y, chr(170), 'Divine gauntlets', libtcod.yellow, equipment=equipment_component, item=None, always_visible=True)

	##BODY ARMOR##

	elif choice == 'nothing':#Allows a possibility to spawn nothing
		item = item = Object(x, y, chr(1), 'nothing', libtcod.darker_orange, equipment=None, item=None, always_visible=False)

	elif choice == 'wooden ring mail':
		equipment_component = Equipment(slot='body', defense_bonus=2)
		item = Object(x, y, chr(2), 'Wooden ring mail', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'bronze ring mail':
		equipment_component = Equipment(slot='body', defense_bonus=4)
		item = Object(x, y, chr(22), 'Bronze ring mail', libtcod.orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel ring mail':
		equipment_component = Equipment(slot='body', defense_bonus=8)
		item = Object(x, y, chr(22), 'Steel ring mail', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel plate armor':
		equipment_component = Equipment(slot='body', defense_bonus=14)
		item = Object(x, y, chr(21), 'Steel plate armor', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'obsidian plate armor':
		equipment_component = Equipment(slot='body', defense_bonus=20)
		item = Object(x, y, chr(21), 'Obsidian plate armor', libtcod.black, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'hercules armor':
		equipment_component = Equipment(slot='body', defense_bonus=30)
		item = Object(x, y, chr(21), "Hercules's armor", libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	##RINGS##

	elif choice == 'wooden ring of health':
		equipment_component = Equipment(slot='finger', max_hp_bonus=10)
		item = Object(x, y, chr(249), 'Wooden ring of health', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'wooden ring of strength':
		equipment_component = Equipment(slot='finger', power_bonus=1)
		item = Object(x, y, chr(249), 'Wooden ring of strength', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'wooden ring of defense':
		equipment_component = Equipment(slot='finger', defense_bonus=1)
		item = Object(x, y, chr(249), 'Wooden ring of defense', libtcod.darker_orange, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel ring of health':
		equipment_component = Equipment(slot='finger', max_hp_bonus=25)
		item = Object(x, y, chr(249), 'Steel ring of health', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel ring of strength':
		equipment_component = Equipment(slot='finger', power_bonus=5)
		item = Object(x, y, chr(249), 'Steel ring of strength', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'steel ring of defense':
		equipment_component = Equipment(slot='finger', defense_bonus=3)
		item = Object(x, y, chr(249), 'Steel ring of defense', libtcod.silver, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'golden ring of health':
		equipment_component = Equipment(slot='finger', max_hp_bonus=50)
		item = Object(x, y, chr(249), 'Golden ring of health', libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'golden ring of strength':
		equipment_component = Equipment(slot='finger', power_bonus=8)
		item = Object(x, y, chr(249), 'Golden ring of strength', libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'golden ring of defense':
		equipment_component = Equipment(slot='finger', defense_bonus=5)
		item = Object(x, y, chr(249), 'Golden ring of defense', libtcod.gold, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'diamond ring of health':
		equipment_component = Equipment(slot='finger', max_hp_bonus=80)
		item = Object(x, y, chr(249), 'Diamond ring of health', libtcod.light_blue, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'diamond ring of strength':
		equipment_component = Equipment(slot='finger', power_bonus=15)
		item = Object(x, y, chr(249), 'Diamond ring of strength', libtcod.light_blue, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'diamond ring of defense':
		equipment_component = Equipment(slot='finger', defense_bonus=10)
		item = Object(x, y, chr(249), 'Diamond ring of defense', libtcod.light_blue, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'glowing ring of health':
		equipment_component = Equipment(slot='finger', max_hp_bonus=125)
		item = Object(x, y, chr(249), 'Diamond ring of health', libtcod.yellow, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'glowing ring of strength':
		equipment_component = Equipment(slot='finger', power_bonus=25)
		item = Object(x, y, chr(249), 'Diamond ring of strength', libtcod.yellow, equipment=equipment_component, item=None, always_visible=True)

	elif choice == 'glowing ring of defense':
		equipment_component = Equipment(slot='finger', defense_bonus=15)
		item = Object(x, y, chr(249), 'Diamond ring of defense', libtcod.yellow, equipment=equipment_component, item=None, always_visible=True)
